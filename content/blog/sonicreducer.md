...
date = 2016-01-04
description = "Hierarchical reduction of sequences and iterables in Scala."
[taxonomies]
...
I use this extensively in my [immutable collections library](@/blog/array-based-immutable-collections.md), where I construct sets by having an union operation that is efficient for sets of roughly the same size.
