...
date = 2018-06-08
description = "How to safely expose an IPFS gateway using nginx as a reverse proxy."
[taxonomies]
tags = ["ipfs"]
+++
...
will return hash of the *current* content of this blog. This is automatically updated by continuous integration whenever I post something new. See [my previous post](@/blog/publish-blog-on-ipfs.md) on how that works.
